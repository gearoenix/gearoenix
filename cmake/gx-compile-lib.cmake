FUNCTION(GX_COMPILE_LIB DIR)
    ...
    IF(NOT EXISTS "${BUILD_DIR}")
    	...
    	EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -H${DIR} -B${BUILD_DIR} -DCMAKE_BUILD_TYPE=Release ${GX_CMAKE_ARGS})
    	EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} --build ${BUILD_DIR} --config Release)
    	EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -H${DIR} -B${BUILD_DIR} -DCMAKE_BUILD_TYPE=Debug ${GX_CMAKE_ARGS})
