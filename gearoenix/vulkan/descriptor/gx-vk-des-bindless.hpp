...
public:
    ...
    [[nodiscard]] std::optional<std::uint32_t> allocate_sampled_image(VkImageView view, VkSampler sampler, VkImageLayout layout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
