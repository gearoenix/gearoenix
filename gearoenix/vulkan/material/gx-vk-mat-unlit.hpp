...
public:
    ...
    void bind_forward(VkCommandBuffer cmd, bool skinned, const pipeline::FormatPipelines& fp, pipeline::PushConstants& pc, VkPipeline& current_bound_pipeline) override;
