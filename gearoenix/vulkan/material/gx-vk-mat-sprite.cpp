...
void gearoenix::vulkan::material::Sprite::bind_forward(const VkCommandBuffer cmd, const bool skinned, const pipeline::FormatPipelines& fp, pipeline::PushConstants& pc, VkPipeline& current_bound_pipeline)
{
