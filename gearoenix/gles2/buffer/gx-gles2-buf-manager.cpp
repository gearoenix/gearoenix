...
std::shared_ptr<gearoenix::render::buffer::Uniform> gearoenix::gles2::buffer::Manager::create_uniform(const std::size_t size, const std::size_t frame_number) noexcept
{
