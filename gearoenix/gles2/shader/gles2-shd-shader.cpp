...
GLuint gearoenix::gles2::shader::Shader::set_vertex_shader(const std::string & shd)
{
	return add_shader_to_program(shd, GL_VERTEX_SHADER);
}

GLuint gearoenix::gles2::shader::Shader::set_fragment_shader(const std::string & shd)
{
