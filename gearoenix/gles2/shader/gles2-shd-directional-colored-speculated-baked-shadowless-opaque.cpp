    ...
    : Shader(eng, end)
{
    eng->add_load_function([this, end] {
        ...
        const std::string pvs = "precision highp samplerCube;\n"
                                ...
                                "varying vec3 pos;\n"
                                "varying vec3 nrm;\n"
                                "varying vec3 eye_rfl;\n"
                                "varying vec3 eye_pos;\n"
                                "varying vec3 sun_rfl;\n"
                                "uniform mat4 mvp;\n"
                                "uniform mat4 m;\n"
                                "uniform vec3 eye;\n"
                                "uniform vec3 sun;\n"
                                ...
                                "    eye_pos = normalize(eye - pos);\n"
                                "    eye_rfl = -reflect(eye_pos, nrm);\n"
                                "    sun_rfl = reflect(sun, nrm);\n"
        ...
        const std::string pfs = "precision highp samplerCube;\n"
                                ...
                                "    float spec = -dot(sun_rfl, eye_pos);\n"
                                "    vec3 env_color = textureCube(rfl_env, eye_rfl).xyz;\n"
