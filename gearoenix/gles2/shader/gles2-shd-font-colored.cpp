...
gearoenix::gles2::shader::FontColored::FontColored(Engine* eng, core::EndCaller<core::EndCallerIgnore> end)
    : Shader(eng, end)
{
    eng->add_load_function([this, end] {
        ...
        const std::string pfs = "#version 100\n"
                                ...
                                "void main()\n"
                                "{\n"
                                "    vec3 final_color = texture2D(txt2d, out_uv).xyz * color;\n"
                                "    gl_FragColor = vec4(final_color, final_color.x);\n"
                                "}\n";
