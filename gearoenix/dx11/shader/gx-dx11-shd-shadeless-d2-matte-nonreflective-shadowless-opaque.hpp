...
#ifdef USE_DIRECTX11
#include "../../render/material/gx-rnd-mat-shadeless-d2-matte-nonreflective-shadowless-opaque.hpp"
...
namespace dx11 {
    ...
    namespace shader {
        ...
        public:
            ShadelessD2MatteNonreflectiveShadowlessOpaque(core::Id my_id, Engine* eng, core::sync::EndCaller<core::sync::EndCallerIgnore> end);
