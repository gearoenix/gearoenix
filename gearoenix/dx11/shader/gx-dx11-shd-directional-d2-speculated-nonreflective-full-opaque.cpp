#include "gx-dx11-shd-directional-d2-speculated-nonreflective-full-opaque.hpp"
#ifdef USE_DIRECTX11
...
gearoenix::dx11::shader::DirectionalD2SpeculatedNonreflectiveFullOpaque::DirectionalD2SpeculatedNonreflectiveFullOpaque(core::Id my_id, Engine* eng, core::sync::EndCaller<core::sync::EndCallerIgnore> end)
