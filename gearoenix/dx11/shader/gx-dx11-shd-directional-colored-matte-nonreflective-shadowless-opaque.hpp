...
//#ifdef USE_DIRECTX11
//#include "../../render/material/gx-rnd-mat-directional-colored-matte-nonreflective-shadowless-opaque.hpp"
...
//
//        public:
//            DirectionalColoredMatteNonreflectiveShadowlessOpaque(Engine* eng, std::shared_ptr<core::sync::EndCaller> end);
