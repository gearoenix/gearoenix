#include "gx-dx11-shd-font-colored.hpp"
#ifdef USE_DIRECTX11
...
gearoenix::dx11::shader::FontColored::FontColored(core::Id my_id, Engine* eng, core::sync::EndCaller<core::sync::EndCallerIgnore> end)
