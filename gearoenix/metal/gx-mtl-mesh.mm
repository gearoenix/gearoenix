...
gearoenix::metal::Mesh::Mesh(id<MTLBuffer> vb, id<MTLBuffer> ib, math::Aabb3<core::fp_t>&& box, const NSUInteger vertex_size, const NSUInteger vertices_size, const NSUInteger indices_count)
...
std::shared_ptr<gearoenix::render::mesh::Mesh> gearoenix::metal::MeshManager::build(std::string&& name, std::vector<render::PbrVertex>&& vertices, std::vector<std::uint32_t>&& indices, math::Aabb3<core::fp_t>&& occlusion_box, core::job::EndCaller&& c)
{
