...
public:
    Aabb3(const math::Vec3<double>& upper, const math::Vec3<double>& lower, std::string&& name) noexcept;
    Aabb3(const math::Aabb3<double>& original_box, std::string&& name) noexcept;
