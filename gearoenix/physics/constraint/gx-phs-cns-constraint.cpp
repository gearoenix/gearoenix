...
gearoenix::physics::constraint::Constraint::Constraint(const core::Id id, const Type t, std::string n, const bool a)
...
void gearoenix::physics::constraint::Constraint::add_affected(const std::shared_ptr<render::model::Model>& m)
{
#ifdef GX_DEBUG_MODE
