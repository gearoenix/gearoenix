...
struct Manager;
typedef boost::container::flat_map<core::fp_t, Keyframe<math::Vec3<core::fp_t>>> Vec3KeyFrameMap;
typedef boost::container::flat_map<core::fp_t, Keyframe<math::Quat<core::fp_t>>> QuatKeyFrameMap;
struct Bone final : core::ecs::Component {
    ...
    GX_GET_CREF_PRV(math::Mat4x4<core::fp_t>, inverse_bind_matrix);
    GX_GET_CREF_PRV(math::Mat4x4<core::fp_t>, bind_matrix);
