...
void gearoenix::physics::animation::ArmatureAnimation::animate(const core::fp_t time)
{
    animate(*root_bone, time);
}

void gearoenix::physics::animation::ArmatureAnimation::animate(const Bone& bone, const core::fp_t time)
{
...
gearoenix::math::Vec2<gearoenix::core::fp_t> gearoenix::physics::animation::ArmatureAnimation::get_start_end() const
{
    math::Vec2 start_end { std::numeric_limits<core::fp_t>::max(), -std::numeric_limits<core::fp_t>::max() };
...
gearoenix::physics::animation::SpriteAnimation::SpriteAnimation(std::string&& name, std::shared_ptr<render::material::Sprite>&& sprite, const std::uint32_t width, const std::uint32_t height)
    ...
    , count(static_cast<core::fp_t>(width * height))
    , aspect(width, height)
    , uv_scale(static_cast<core::fp_t>(1) / static_cast<core::fp_t>(width), static_cast<core::fp_t>(1) / static_cast<core::fp_t>(height))
{
}

void gearoenix::physics::animation::SpriteAnimation::animate(const core::fp_t time)
{
...
gearoenix::math::Vec2<gearoenix::core::fp_t> gearoenix::physics::animation::SpriteAnimation::get_start_end() const
{
    GX_UNIMPLEMENTED;
}
...
void gearoenix::physics::animation::AnimationPlayer::show_debug_gui()
{
    render::imgui::tree_scope(this, [this] {
        ...
        render::imgui::table_scope("##gearoenix::physics::animation::AnimationPlayer::show_debug_gui", [this] {
            ImGui::Text("Time: ");
            ImGui::TableNextColumn();
            (void)render::imgui::input("##time", time);
            ImGui::TableNextColumn();

            ImGui::Text("Speed: ");
            ImGui::TableNextColumn();
            (void)render::imgui::input("##speed", speed);
            ImGui::TableNextColumn();
            ...
            ImGui::TableNextColumn();
            (void)render::imgui::input("##loop_start_time", loop_start_time);
            ImGui::TableNextColumn();

            ImGui::Text("Loop End Time: ");
            ImGui::TableNextColumn();
            (void)render::imgui::input("##loop_end_time", loop_end_time);
            ImGui::TableNextColumn();
...
gearoenix::physics::animation::AnimationPlayer::AnimationPlayer(core::ecs::Entity* const entity, std::shared_ptr<Animation>&& animation, std::string&& name, const core::fp_t starting_time)
...
void gearoenix::physics::animation::AnimationPlayer::update_time(const core::fp_t delta_time)
{
...
void gearoenix::physics::animation::AnimationPlayer::set_loop_start_time(const core::fp_t t)
{
    loop_start_time = t;
    loop_length_time = loop_end_time - loop_start_time;
}

void gearoenix::physics::animation::AnimationPlayer::set_loop_end_time(const core::fp_t t)
{
    loop_end_time = t;
    loop_length_time = loop_end_time - loop_start_time;
}

void gearoenix::physics::animation::AnimationPlayer::set_loop_range_time(const core::fp_t start, const core::fp_t end)
{
