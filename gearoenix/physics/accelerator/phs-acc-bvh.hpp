...
public:
    ...
    [[nodiscard]] std::optional<std::pair<core::Real, collider::Collider*>> hit(const math::Ray3& r, core::Real d_min) const noexcept;
    [[nodiscard]] std::string to_string() const noexcept;
    void call_on_intersecting(collider::Collider* cld, std::function<void(collider::Collider* cld)> collided) const noexcept;
};
}
#endif
