...
gearoenix::glc3::pipeline::Manager::~Manager() noexcept {}

std::shared_ptr<gearoenix::render::pipeline::Pipeline> gearoenix::glc3::pipeline::Manager::get(const render::pipeline::Type::Id pipeline_type_id, core::sync::EndCaller<render::pipeline::Pipeline>& end) noexcept
{
