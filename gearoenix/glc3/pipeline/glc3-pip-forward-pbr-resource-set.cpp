...
void gearoenix::glc3::pipeline::ForwardPbrResourceSet::bind_final(gl::uint& bound_shader_program) const noexcept
{
    ...
    reinterpret_cast<const texture::TextureCube*>(radiance)->bind(static_cast<gl::enumerated>(shdr->get_effect_specular_environment_index()));
    ...
    GX_GLC3_PIP_RES_SET_UNIFORM(material_emission_factor, *(material->emission_factor.data()))
