...
namespace shader {
    ...
    private:
        ...
        GX_GLC3_UNIFORM_FLOAT(effect_shadow_caster_directional_lights_cascades_count, GX_MAX_DIRECTIONAL_LIGHTS_SHADOW_CASTER)
        ...
        GX_GLC3_UNIFORM_VECTOR(effect_shadow_caster_directional_lights_color, 3, GX_MAX_DIRECTIONAL_LIGHTS_SHADOW_CASTER)
		GX_GLC3_UNIFORM_FLOAT(effect_shadow_caster_directional_lights_count, 1)
        GX_GLC3_UNIFORM_VECTOR(effect_shadow_caster_directional_lights_direction, 3, GX_MAX_DIRECTIONAL_LIGHTS_SHADOW_CASTER)
