...
public:                                                  \
    [[nodiscard]] const t& get_##x() const { return x; } \
    v:                                                   \
    c t x
#define GX_GET_REF(v, t, x)                  \
public:                                      \
    [[nodiscard]] t& get_##x() { return x; } \
    GX_GET_CREF(v, , t, x)
#define GX_GETSET_CREF(v, t, x)             \
public:                                     \
    void set_##x(const t& arg) { x = arg; } \
    GX_GET_CREF(v, , t, x)
...
public:                                                        \
    [[nodiscard]] const t* get_##x() const { return x.get(); } \
    [[nodiscard]] t* get_##x() { return x.get(); }             \
    v:                                                         \
...
public:                                                            \
    void set_##x(std::unique_ptr<t> _##x) { x = std::move(_##x); } \
    GX_GET_UPTR(v, , t, x)
...
public:                                       \
    void set_##x(t* const _##x) { x = _##x; } \
    GX_GET_PTR(v, , t, x)
#define GX_GETSET_PTRC(v, t, x)                     \
public:                                             \
    void set_##x(const t* const _##x) { x = _##x; } \
...
public:                                                                 \
    [[nodiscard]] const std::array<t, c>& get_##x() const { return x; } \
    v:                                                                  \
...
public:                                                     \
    [[nodiscard]] std::array<t, c>& get_##x() { return x; } \
    GX_GET_ARRC(v, t, x, c)
