...
public:                                             \
    [[nodiscard]] const t& get_##x() const noexcept \
    {                                               \
        return x;                                   \
    }                                               \
    v:                                              \
...
public:                                            \
    void set_##x(std::unique_ptr<t> _##x) noexcept \
    {                                              \
        x = std::move(_##x);                       \
    }                                              \
    GX_GET_UPTR(v, , t, x)
...
public:                                  \
    void set_##x(t* const _##x) noexcept \
    {                                    \
        x = _##x;                        \
    }                                    \
    GX_GET_PTR(v, , t, x)
...
public:                                        \
    void set_##x(const t* const _##x) noexcept \
    {                                          \
        x = _##x;                              \
    }                                          \
...
public:                                                            \
    [[nodiscard]] const std::array<t, c>& get_##x() const noexcept \
    {                                                              \
        return x;                                                  \
    }                                                              \
    v:                                                             \
...
public:                                                \
    [[nodiscard]] std::array<t, c>& get_##x() noexcept \
    {                                                  \
        return x;                                      \
    }                                                  \
    GX_GET_ARRC(v, t, x, c)
...
public:                                 \
    void set_##x(const t _##x) noexcept \
    {                                   \
        x = _##x;                       \
    }                                   \
    GX_GET_VAL(v, t, x, d)
