...
constexpr auto gearoenix_gapi_mesh_type_index = gearoenix_object_type_index_start + 6;
constexpr auto gearoenix_physics_animation_type_index = gearoenix_object_type_index_start + 7;
constexpr auto gearoenix_physics_animation_armature_animation_type_index = gearoenix_object_type_index_start + 8;
constexpr auto gearoenix_physics_animation_sprite_animation_type_index = gearoenix_object_type_index_start + 9;
constexpr auto gearoenix_render_material_type_index = gearoenix_object_type_index_start + 10;
constexpr auto gearoenix_render_material_pbr_type_index = gearoenix_object_type_index_start + 11;
constexpr auto gearoenix_render_material_sprite_type_index = gearoenix_object_type_index_start + 12;
constexpr auto gearoenix_render_material_unlit_type_index = gearoenix_object_type_index_start + 13;
constexpr auto gearoenix_render_mesh_type_index = gearoenix_object_type_index_start + 14;

constexpr auto gearoenix_last_object_type_index = gearoenix_core_component_type_index_start + 15;