...
/// For all types which are derived from @code gearoenix::core::ecs::Component @endcode or they have a derived class that is
...
constexpr auto gearoenix_physics_animation_type_index = gearoenix_object_type_index_start + 2;
constexpr auto gearoenix_physics_animation_armature_animation_type_index = gearoenix_object_type_index_start + 3;
constexpr auto gearoenix_physics_animation_sprite_animation_type_index = gearoenix_object_type_index_start + 4;
