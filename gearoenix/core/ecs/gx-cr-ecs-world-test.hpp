...
BOOST_AUTO_TEST_CASE(gearoenix_core_ecs_world)
{
    ...
    const auto e1 = w.create_entity(Position { 2.0, 3.0 }, Speed { 4.0, 5.0 });
    const auto e2 = w.create_entity(Position { 6.0, 7.0 });
    const auto e3 = w.create_entity(Speed { 10.0, 11.0 }, Position { 8.0, 9.0 });
    const auto e4 = w.create_entity(Speed { 12.0, 13.0 });
