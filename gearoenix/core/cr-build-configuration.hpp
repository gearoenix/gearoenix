...
#define GX_MAX_DIRECTIONAL_LIGHTS_SHADOW_CASTER_STR GX_XSTR(GX_MAX_DIRECTIONAL_LIGHTS_SHADOW_CASTER)
...
#define GX_MAX_DIRECTIONAL_LIGHTS_CASCADES_STR GX_XSTR(GX_MAX_DIRECTIONAL_LIGHTS_CASCADES)
#define GX_MAX_RUNTIME_REFLECTION_ENVIRONMENT_RESOLUTION 512
#define GX_MAX_RUNTIME_REFLECTION_IRRADIANCE_RESOLUTION 32
#define GX_MAX_RUNTIME_REFLECTION_RADIANCE_RESOLUTION 128
#define GX_MAX_RUNTIME_REFLECTION_RADIANCE_LEVELS 5
#define GX_MAX_RUNTIME_REFLECTION_RADIANCE_LEVELS_STR GX_XSTR(GX_MAX_RUNTIME_REFLECTION_RADIANCE_LEVELS)
