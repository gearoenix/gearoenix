#include "gles3-shd-effect-forward-pbr-directional-shadow.hpp"
...
gearoenix::gles3::shader::ForwardPbrDirectionalShadow::ForwardPbrDirectionalShadow(engine::Engine* const e, const core::sync::EndCaller<core::sync::EndCallerIgnore>& c) noexcept
    : Shader(e, c)
{
	GX_GLES3_SHADER_SRC_DEFAULT_VERTEX_STARTING << 
		// camera uniform(s)
		...
		"}";
	GX_GLES3_SHADER_SRC_DEFAULT_FRAGMENT_STARTING <<
	...
	e->get_function_loader()->load([this, vertex_shader_code{ move(vertex_shader_code.str()) }, fragment_shader_code{ move(fragment_shader_code.str()) }]{
        ...
        GX_GLES3_THIS_GET_UNIFORM_F(camera_position)
        GX_GLES3_THIS_GET_UNIFORM_F(camera_vp)
        // TODO
        //GX_GLES3_THIS_GET_UNIFORM_F(effect_ambient_occlusion)
        GX_GLES3_THIS_GET_UNIFORM_TEXTURE_F(effect_brdflut)
        GX_GLES3_THIS_GET_UNIFORM_F(effect_cascades_count)
        GX_GLES3_THIS_GET_UNIFORM_TEXTURE_F(effect_diffuse_environment)
        GX_GLES3_THIS_GET_UNIFORM_TEXTURE_F(effect_shadow_map)
        GX_GLES3_THIS_GET_UNIFORM_TEXTURE_F(effect_specular_environment)
        GX_GLES3_THIS_GET_UNIFORM_F(effect_view_projection_biases)
        GX_GLES3_THIS_GET_UNIFORM_F(light_color)
        GX_GLES3_THIS_GET_UNIFORM_F(light_direction)
        GX_GLES3_THIS_GET_UNIFORM_F(model_m)
        // GX_GLES2_THIS_GET_UNIFORM_F(scene_ambient_light)
        GX_GLES3_THIS_GET_UNIFORM_F(scene_directional_lights_color)
        GX_GLES3_THIS_GET_UNIFORM_F(scene_directional_lights_direction)
        GX_GLES3_THIS_GET_UNIFORM_F(scene_lights_count)
        GX_GLES3_THIS_GET_UNIFORM_F(scene_point_lights_color_min_radius)
        GX_GLES3_THIS_GET_UNIFORM_F(scene_point_lights_position_max_radius)
...
void gearoenix::gles3::shader::ForwardPbrDirectionalShadow::bind() const noexcept
{
    ...
    GX_GLES3_SHADER_SET_TEXTURE_INDEX_UNIFORM(effect_ambient_occlusion)
    GX_GLES3_SHADER_SET_TEXTURE_INDEX_UNIFORM(effect_brdflut)
    GX_GLES3_SHADER_SET_TEXTURE_INDEX_UNIFORM(effect_diffuse_environment)
    GX_GLES3_SHADER_SET_TEXTURE_INDEX_UNIFORM(effect_shadow_map)
    GX_GLES3_SHADER_SET_TEXTURE_INDEX_UNIFORM(effect_specular_environment)
}
#endif
