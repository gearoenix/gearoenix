#include "gles3-shd-directional-d2-speculated-baked-full-opaque.hpp"
...
gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::Resources::Resources(Engine* e, pipeline::Pipeline* pip, buffer::Uniform* u)
    : render::material::DirectionalD2SpeculatedBakedFullOpaque::Resources(e, pip, u)
{
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::Resources::bind()
{
    render::material::DirectionalD2SpeculatedBakedFullOpaque::Uniform* data = static_cast<render::material::DirectionalD2SpeculatedBakedFullOpaque::Uniform*>(u->get_data());
    ...
    static_cast<texture::Texture2D*>(txt)->bind(GL_TEXTURE1);
    static_cast<texture::Texture2D*>(shdtxt)->bind(GL_TEXTURE2);
}

gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::DirectionalD2SpeculatedBakedFullOpaque(core::Id my_id, Engine* eng, core::sync::EndCaller<core::sync::EndCallerIgnore> end)
    : Shader(my_id, eng, end)
{
    eng->add_load_function([this, end] {
        ...
        const std::string pfs = "#version 330\n"
                                ...
                                "    if(diff_fac < 0.001)\n"
                                "    {\n"
                                "        frag_color = vec4(ambl_light + (env_color * rfl_fac), 1.0);\n"
                                "    }\n"
                                "    else\n"
                                "    {\n"
...
gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::~DirectionalD2SpeculatedBakedFullOpaque()
{
    if (vtx_shd == 0)
        return;
...
void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::use()
{
    glUseProgram(shader_program);
    glUniform1i(rfl_env, 0);
    glUniform1i(txt, 1);
...
const std::vector<gearoenix::render::shader::stage::Id>& gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::get_stages_ids() const
{
    return graphic_2_stage;
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_vp(const GLfloat* data)
{
    glUniformMatrix4fv(vp, 1, GL_FALSE, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_m(const GLfloat* data)
{
    glUniformMatrix4fv(m, 1, GL_FALSE, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_sun(const GLfloat* data)
{
    glUniform3fv(sun, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_sun_color(const GLfloat* data)
{
    glUniform3fv(sun_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_eye(const GLfloat* data)
{
    glUniform3fv(eye, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_spec_color(const GLfloat* data)
{
    glUniform3fv(spec_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_spec_factors(const GLfloat* data)
{
    glUniform3fv(spec_factors, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_ambl_color(const GLfloat* data)
{
    glUniform3fv(ambl_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_db(const GLfloat* data)
{
    glUniformMatrix4fv(db, 1, GL_FALSE, data);
}

void gearoenix::gles3::shader::DirectionalD2SpeculatedBakedFullOpaque::set_rfl_fac(const GLfloat data)
{
