...
GLuint gearoenix::gles3::shader::Shader::add_shader_to_program(const std::string& shd, const GLenum& shader_type)
{
...
GLuint gearoenix::gles3::shader::Shader::get_uniform_location(const std::string& uname)
{
...
void gearoenix::gles3::shader::Shader::end_program()
{
    glDeleteProgram(shader_program);
}

void gearoenix::gles3::shader::Shader::end_object(const GLuint& shader_object)
{
    glDeleteShader(shader_object);
}

gearoenix::gles3::shader::Shader::Shader(Engine* eng, core::EndCaller<core::EndCallerIgnore>)
    : eng(eng)
{
}
