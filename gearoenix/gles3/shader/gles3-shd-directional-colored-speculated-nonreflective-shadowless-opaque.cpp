#include "gles3-shd-directional-colored-speculated-nonreflective-shadowless-opaque.hpp"
...
gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::Resources::Resources(Engine* e, pipeline::Pipeline* pip, buffer::Uniform* u)
    : render::material::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::Resources(e, pip, u)
{
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::Resources::bind()
{
...
gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque(core::Id my_id, Engine* eng, core::sync::EndCaller<core::sync::EndCallerIgnore> end)
...
gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::~DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque()
{
    if (vtx_shd == 0)
        return;
...
void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::use()
{
    glUseProgram(shader_program);
}

const std::vector<gearoenix::render::shader::stage::Id>& gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::get_stages_ids() const
{
    return graphic_2_stage;
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_vp(const GLfloat* data)
{
    glUniformMatrix4fv(vp, 1, GL_FALSE, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_m(const GLfloat* data)
{
    glUniformMatrix4fv(m, 1, GL_FALSE, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_sun(const GLfloat* data)
{
    glUniform3fv(sun, 1, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_sun_color(const GLfloat* data)
{
    glUniform3fv(sun_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_ambl_color(const GLfloat* data)
{
    glUniform3fv(ambl_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_spec_color(const GLfloat* data)
{
    glUniform3fv(spec_color, 1, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_spec_factors(const GLfloat* data)
{
    glUniform3fv(spec_factors, 1, data);
}

void gearoenix::gles3::shader::DirectionalColoredSpeculatedNonreflectiveShadowlessOpaque::set_eye(const GLfloat* data)
{
