...
gearoenix::render::texture::Texture2D* gearoenix::gles3::Engine::create_texture_2d(system::file::File* file, core::EndCaller<core::EndCallerIgnore> c)
{
    return new texture::Texture2D(file, this, c);
}

gearoenix::render::texture::Cube* gearoenix::gles3::Engine::create_texture_cube(system::file::File* file, core::EndCaller<core::EndCallerIgnore> c)
{
    return new texture::Cube(file, this, c);
}

gearoenix::render::buffer::Mesh* gearoenix::gles3::Engine::create_mesh(unsigned int vec, system::file::File* file, core::EndCaller<core::EndCallerIgnore> c)
{
...
gearoenix::render::shader::Shader* gearoenix::gles3::Engine::create_shader(core::Id sid, system::file::File*, core::EndCaller<core::EndCallerIgnore> c)
{
