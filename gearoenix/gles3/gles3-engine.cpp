...
gearoenix::render::texture::Texture2D* gearoenix::gles3::Engine::create_texture_2d(system::stream::Stream* file, core::EndCaller<core::EndCallerIgnore> c)
{
    return new texture::Texture2D(file, this, c);
}

gearoenix::render::texture::Cube* gearoenix::gles3::Engine::create_texture_cube(system::stream::Stream* file, core::EndCaller<core::EndCallerIgnore> c)
{
