...
struct Vec2 final {
    ...
    {
        static_assert(!is_deep_same_v<T>, "Only different type can be constructed by this constructor.");
    }

    template <typename T>
    constexpr std::conditional_t<is_deep_same_v<T>, const Vec2&, Vec2<T>> to() const
    {
