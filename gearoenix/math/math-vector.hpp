...
namespace math {
    ...
    public:
        ...
        bool operator==(const Vec2& o) const noexcept;
        bool operator>(const Vec2& o) const noexcept;
        core::Real dot(const Vec2& o) const noexcept;
        core::Real cross(const Vec2& o) const noexcept;
        core::Real length() const noexcept;
        core::Real square_length() const noexcept;
        core::Real distance(const Vec2& a) const noexcept;
    ...
    public:
        ...
        core::Real length() const noexcept;
        core::Real square_length() const noexcept;
        core::Real square_distance(const Vec3& a) const noexcept;
