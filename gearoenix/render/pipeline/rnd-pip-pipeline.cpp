...
gearoenix::render::pipeline::Pipeline::Pipeline(const Type::Id pipeline_type, const std::shared_ptr<engine::Engine> e, const core::sync::EndCaller<core::sync::EndCallerIgnore>&)
    : e(e)
