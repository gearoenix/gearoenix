...
gearoenix::core::ecs::EntityPtr gearoenix::render::light::Manager::build_directional(std::string&& name, core::ecs::Entity* const parent)
{
    ...
    entity->add_component(core::Object::construct<Directional>(entity.get(), name + "-directional-light"));
    entity->add_component(core::Object::construct<physics::Transformation>(entity.get(), name + "-light-directional-transform"));
    return entity;
}
