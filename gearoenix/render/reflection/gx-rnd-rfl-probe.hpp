...
struct Probe : core::ecs::Component {
    ...
    Probe(core::ecs::Entity* entity, core::object_type_index_t final_component_type_index, std::shared_ptr<texture::TextureCube>&& irradiance, std::shared_ptr<texture::TextureCube>&& radiance, const math::Aabb3<core::fp_t>& include_box,
        std::string&& name);
    Probe(core::ecs::Entity* entity, core::object_type_index_t final_component_type_index, const math::Aabb3<core::fp_t>& include_box, std::string&& name);
