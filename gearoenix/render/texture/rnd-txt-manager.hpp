...
public:
    ...
    [[nodiscard]] std::shared_ptr<Texture2D> create_2d_f(const std::string& file_address, core::sync::EndCaller<Texture2D>& c, const SampleInfo& sample_info = SampleInfo()) noexcept;
