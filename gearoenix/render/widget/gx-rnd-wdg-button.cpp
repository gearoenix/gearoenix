...
{
    core::job::EndCallerShared<material::Unlit> mat_end(
        [n = std::move(name), pt = std::move(pressed_texture_asset), r = std::move(rest_texture_asset), c = camera_entity, p = std::move(parent), e = std::move(end_callback)](std::shared_ptr<material::Unlit>&& m) mutable {
    ...
    core::job::EndCallerShared<Button>&& end_callback)
{
    ...
    core::job::EndCallerShared<texture::Texture2D> te(
        [n = std::move(name), m = std::move(mat), r = std::move(rest_texture_asset), c = camera_entity, p = std::move(parent), e = std::move(end_callback)](std::shared_ptr<texture::Texture2D>&& pt) mutable {
            construct(std::move(n), std::move(m), std::move(pt), std::move(r), c, std::move(p), std::move(e));
        });
    ...
    core::job::EndCallerShared<Button>&& end_callback)
{
    ...
    core::job::EndCallerShared<texture::Texture2D> te(
        [n = std::move(name), m = std::move(mat), pt = std::move(pressed_texture), c = camera_entity, p = std::move(parent), e = std::move(end_callback)](std::shared_ptr<texture::Texture2D>&& r) mutable {
            construct(std::move(n), std::move(m), std::move(pt), std::move(r), c, std::move(p), std::move(e));
        });
    texture::Manager::get().create_2d_from_file(path, texture::TextureInfo(), std::move(te));
}
    ...
    core::job::EndCallerShared<Button>&& end_callback)
{
    ...
    mesh::Manager::get().build_plate(
        ...
        core::job::EndCallerShared<mesh::Mesh>(
            [n = std::move(name), m = std::move(mat), pt = std::move(pressed_texture), r = std::move(rest_texture), c = camera_entity, p = std::move(parent), e = std::move(end_callback)](std::shared_ptr<mesh::Mesh>&& bm) mutable {
    ...
    core::job::EndCallerShared<Button>&& end_callback)
{
    ...
    auto model_entity = model::Manager::get().build(
        name + "-model", parent ? parent->get_model_entity().get() : nullptr, { std::move(button_mesh) }, true, nullptr);
...
void gearoenix::render::widget::Button::set_on_press(const std::function<void(const math::Vec3<core::fp_t>&)>& fun)
{
    set_on_press_impl(fun);
}

void gearoenix::render::widget::Button::set_on_release(const std::function<void(const math::Vec3<core::fp_t>&)>& fun)
{
