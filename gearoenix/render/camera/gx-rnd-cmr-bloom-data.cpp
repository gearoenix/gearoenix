...
//     const std::shared_ptr<texture::Target>& second_target,
//     core::job::EndCaller<BloomData>&& end_caller)
// {
//     end_caller.set_return(BloomData {});
//
//     // S0 -> S1 Prefilter
//     // S1 -> M1 HG ------ M1 -> S2 VG
//     // S2 -> M2 HG ------ M2 -> S3 VG
...
//             core::job::EndCallerShared<texture::Target>([end_caller](std::shared_ptr<texture::Target>&& t) {
//                 end_caller.get_return().prefilter_target = std::move(t);
//             }));
//     }
//
...
//             core::job::EndCallerShared<texture::Target>([end_caller, i](std::shared_ptr<texture::Target>&& t) {
//                 end_caller.get_return().horizontal_targets[i] = std::move(t);
//             }));
//     }
//
...
//             core::job::EndCallerShared<texture::Target>([end_caller, i](std::shared_ptr<texture::Target>&& t) {
//                 end_caller.get_return().vertical_targets[i] = std::move(t);
//             }));
//     }
//
...
//             core::job::EndCallerShared<texture::Target>([end_caller, i](std::shared_ptr<texture::Target>&& t) {
//                 end_caller.get_return().upsampler_targets[i] = std::move(t);
//             }));
//     }
//
