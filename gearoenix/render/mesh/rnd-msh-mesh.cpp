...
gearoenix::render::mesh::Mesh::Mesh(core::Id my_id, system::stream::Stream* f, Engine* e, core::EndCaller<core::EndCallerIgnore> c)
...
gearoenix::render::mesh::Mesh* gearoenix::render::mesh::Mesh::read(core::Id my_id, system::stream::Stream* f, Engine* e, core::EndCaller<core::EndCallerIgnore> c)
{
    core::Id t;
    f->read(t);
    switch (t) {
