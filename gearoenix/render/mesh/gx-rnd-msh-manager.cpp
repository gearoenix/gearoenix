...
#define GEAROENIX_RENDER_MESH_MANAGER_CACHE                                                                                                                                                                                \
    if (buffers.get(name, core::job::EndCallerShared<Buffer>([this, e = end_callback, n = name, m = material](std::shared_ptr<Buffer>&& b) mutable { build(std::move(n), std::move(b), std::move(m), std::move(e)); }))) { \
        return;                                                                                                                                                                                                            \
    }                                                                                                                                                                                                                      \
    static_assert(true, "")
...
void gearoenix::render::mesh::Manager::build_icosphere(const std::uint64_t subdivisions, std::shared_ptr<material::Material>&& material, core::job::EndCallerShared<Mesh>&& end_callback)
{
    ...
    std::vector vertices {
        ...
        PbrVertex(math::Vec3(0.7235999703407288f, -0.5257200002670288f, -0.4472149908542633f), math::Vec3(0.7236069440841675f, -0.5257307291030884f, -0.44721388816833496f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        PbrVertex(math::Vec3(-0.27638500928878784f, -0.8506399989128113f, -0.4472149908542633f), math::Vec3(-0.27638790011405945f, -0.8506532907485962f, -0.4472121298313141f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        PbrVertex(math::Vec3(0.7235999703407288f, 0.5257200002670288f, -0.4472149908542633f), math::Vec3(0.7236069440841675f, 0.5257307291030884f, -0.44721388816833496f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        ...
        PbrVertex(math::Vec3(0.27638500928878784f, -0.8506399989128113f, 0.4472149908542633f), math::Vec3(0.27638792991638184f, -0.8506532907485962f, 0.44721218943595886f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        PbrVertex(math::Vec3(-0.7235999703407288f, -0.5257200002670288f, 0.4472149908542633f), math::Vec3(-0.7236069440841675f, -0.5257307291030884f, 0.44721388816833496f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        PbrVertex(math::Vec3(-0.7235999703407288f, 0.5257200002670288f, 0.4472149908542633f), math::Vec3(-0.7236069440841675f, 0.5257306694984436f, 0.4472138285636902f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
        PbrVertex(math::Vec3(0.27638500928878784f, 0.8506399989128113f, 0.4472149908542633f), math::Vec3(0.2763878405094147f, 0.8506532311439514f, 0.4472121596336365f), math::Vec4(1.0f, 0.0f, 0.0f, -1.0f), math::Vec2(0.4999999701976776f, 0.4999900460243225f)),
    ...
    return build(std::move(name), std::move(vertices), std::move(indices), std::move(material), std::move(end_callback), false);
}
    ...
    const bool use_cache)
{
    ...
    build(std::move(name_copy), std::move(vertices), std::move(indices), occlusion_box,
        core::job::EndCallerShared<Buffer>([this, name = std::move(name)](std::shared_ptr<Buffer>&& buffer) {
    ...
    const bool use_cache)
{
    ...
    return build(std::move(name), std::move(vertices), std::move(indices), occlusion_box, std::move(material), std::move(end_callback), false);
}
