...
struct RuntimeConfiguration final {
    ...
    GX_GETSET_VAL_PRV(std::uint32_t, maximum_allowed_textures_memory_size, 1024 * 1024 * 1024);
    GX_GETSET_VAL_PRV(std::uint32_t, maximum_allowed_meshs_memory_size, 64 * 1024 * 1024);
    GX_GETSET_VAL_PRV(std::uint32_t, maximum_allowed_dynamic_buffer_size, 8 * 1024 * 1024);
