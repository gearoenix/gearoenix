...
void gearoenix::render::scene::Scene::update(const core::ecs::Entity::id_t scene_entity_id) noexcept
{
    ...
    std::uint64_t flag = 1;
    cameras_flags.clear();
    world->synchronised_system<camera::Camera>([&](const core::ecs::Entity::id_t id, camera::Camera* const cam) {
    ...
    world->parallel_system<core::ecs::And<model::Model, physics::Transformation>>(
        [&](const core::ecs::Entity::id_t, model::Model* const mdl, physics::Transformation* const trn, const auto /*kernel_index*/) {
