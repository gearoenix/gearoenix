...
gearoenix::render::material::DirectionalD2SpeculatedBakedFullOpaque::DirectionalD2SpeculatedBakedFullOpaque(system::file::File* f, Engine* e, core::EndCaller<core::EndCallerIgnore> end)
