...
struct SkyboxCube final : public Material {
public:
    struct Uniform {
        float alpha = 1.0f;
...
public:
    ...
    SkyboxCube(platform::stream::Stream* f, engine::Engine* e, const core::sync::EndCaller<core::sync::EndCallerIgnore>& end) noexcept;
