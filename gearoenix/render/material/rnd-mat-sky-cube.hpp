#ifndef GEAROENIX_RENDER_MATERIAL_SKY_CUBE_HPP
#define GEAROENIX_RENDER_MATERIAL_SKY_CUBE_HPP
#include "rnd-mat-material.hpp"

namespace gearoenix::render::material {
class SkyCube : public Material {
public:
    struct Uniform {
...
public:
    SkyCube(engine::Engine* e, const core::sync::EndCaller<core::sync::EndCallerIgnore>& end) noexcept;
    SkyCube(system::stream::Stream* f, engine::Engine* e, const core::sync::EndCaller<core::sync::EndCallerIgnore>& end) noexcept;
    ~SkyCube() noexcept final;
