...
gearoenix::render::material::DirectionalColoredSpeculatedBakedShadowlessOpaque::DirectionalColoredSpeculatedBakedShadowlessOpaque(core::Id shdid, system::stream::Stream* f, Engine* e, core::EndCaller<core::EndCallerIgnore> end)
