...
const gearoenix::core::Id gearoenix::render::material::DirectionalTexturedSpeculatedNonreflectiveFullOpaque::SHADER_ID = gearoenix::render::shader::DIRECTIONAL_TEXTURED_SPECULATED_NONREFLECTIVE_FULL_OPAQUE;
