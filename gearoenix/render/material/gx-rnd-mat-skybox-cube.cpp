#include "gx-rnd-mat-skybox-cube.hpp"
...
gearoenix::render::material::SkyboxCube::SkyboxCube(platform::stream::Stream* const f, engine::Engine* const e, const core::sync::EndCaller<core::sync::EndCallerIgnore>& end) noexcept
    : Material(Type::SkyboxCube, e, sizeof(Uniform))
{
    auto* const txt_mgr = e->get_platform_application()->get_asset_manager()->get_texture_manager();
