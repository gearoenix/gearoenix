    ...
    LPSTR pCmdLine, int nCmdShow)
{
    std::shared_ptr<gearoenix::system::Application> app(
        new gearoenix::system::Application(hInstance, hPrevInstance, pCmdLine,
            nCmdShow));
    return app->execute();
}
...
LRESULT CALLBACK gearoenix::system::Application::process_callback(
...
LRESULT gearoenix::system::Application::handle_message(HWND hWnd, UINT uMsg,
    WPARAM wParam,
    LPARAM lParam)
{
    switch (uMsg) {
...
gearoenix::system::Application::Application(HINSTANCE hInstance,
    ...
    : instance(hInstance)
{
    ...
    window = CreateWindowEx(0, TEXT(APPLICATION_NAME), TEXT(APPLICATION_NAME),
...
const HWND& gearoenix::system::Application::get_hwnd() const { return window; }
#endif
