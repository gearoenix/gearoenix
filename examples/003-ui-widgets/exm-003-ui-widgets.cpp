...
//void Example003UiWidgetsApp::translate_camera(const GxVec3& t)
//{
    ...
    : gearoenix::core::Application::Application(sys_app)
{
    ...
    tmptxt->set_text(L"I'm a one line Text widget. I easily grow horizontally and automatically.", endcall);
    ...
    open_button->set_text(L"I'm a Button widget. I can grow too.", endcall);
    ...
    tmptran->set_location(GxVec3(0.0f, 0.65f, 0.1f));
    file_location->set_hint_text(L"I'm a one line Edit text widget. I don't grow, there is a reason behind it, don't you know it.", endcall);
