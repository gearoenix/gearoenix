...
public:
    GameApp()
    {
        gearoenix::render::gltf::load(
            ...
            // GxPath::create_absolute("../../../../gearoenix/submodules/glTF-Sample-Assets/Models/Avocado/glTF/Avocado.gltf"),
            // GxPath::create_absolute("../../../../gearoenix/submodules/glTF-Sample-Assets/Models/FlightHelmet/glTF/FlightHelmet.gltf"),
