...
../dxc/bin/x64/dxc.exe -T cs_6_5 -Qembed_debug -nologo -Zi -Od -Fo ../assets/gx-dxr-shd-mipmap-generator.cs.cso gearoenix/dxr/shaders/gx-dxr-shd-mipmap-generator.cs.hlsl
